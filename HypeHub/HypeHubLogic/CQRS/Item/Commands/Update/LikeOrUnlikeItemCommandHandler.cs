...
public class LikeOrUnlikeItemCommandHandler : IRequestHandler<LikeOrUnlikeItemCommand, List<AccountItemLikeReadDTO>>
{
    ...
    public LikeOrUnlikeItemCommandHandler(IAccountItemLikeRepository likeRepository, IMapper mapper, IValidator<AccountItemLikeCreateDTO> validator, IAccountRepository accountRepository)
    {
