...
public class FakeDataGeneratorModel
{
    ...
    public FakeDataGeneratorModel(List<Account> accounts, List<AccountCredentials> accountsCredentials, List<Wardrobe> wardrobes, List<Outfit> outfits, List<Item> items, List<OutfitImage> outfitImages, List<ItemImage> itemImages)
    {
        Accounts = accounts;
